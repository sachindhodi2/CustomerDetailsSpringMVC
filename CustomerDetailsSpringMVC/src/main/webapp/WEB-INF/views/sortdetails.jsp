...
.dropdown:hover .dropdown-content {
  display: block;
        ...
        <table border="2" style="width:500px;margin-left:auto;margin-right:auto;" style="text-align:center" class="center">
				<tr>
					<th>id</th>
					<th><a href = "/CustomerDetailsSpringMVC/sort/name/1">Name</button></a></th>
			...
			<br>
			    ...
			    <a href="/CustomerDetailsSpringMVC/sort/${sortingColumns}/${p}">${p}</a>
			    </c:forEach>
			    </td>
	...
	<br><br>
			...
			<table align="center">
                <tr>
			<td> <a href = "/CustomerDetailsSpringMVC/customerreport/3"><button type = "button">Generate Report</button></a></td>
                </tr>
            </table> 
