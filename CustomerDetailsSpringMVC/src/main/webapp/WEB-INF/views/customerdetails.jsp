  ...
  display: block;
        ...
        <table border="2" style="width:500px;margin-left:auto;margin-right:auto;" style="text-align:center" class="center">
			...
			<br>
			    ...
			    <a href="/CustomerDetailsSpringMVC/customerdetails/${p}">${p}</a>
			    </c:forEach>
			    </td>
	...
	<br><br>
			...
			<table align="center">
                <tr>
			<td> <a href = "/CustomerDetailsSpringMVC/customerreport/1"><button type = "button">Generate Report</button></a></td>
                </tr>
            </table> 
